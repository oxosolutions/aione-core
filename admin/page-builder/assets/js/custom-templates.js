...
( function ( $ ) {
	"use strict";
	$.oxoCustomTemplates = ( function () {
		
		var SaveTemplateHandler 	= $( '#oxo_save_custom_tpl' );
		var loadTemplateHanlder 	= $( '.fuiosn_load_template' );
		var deleteTemplateHanlder 	= $( '.oxo_delete_template' );
	...
	$(document).ready(function () {
		...
		$.oxoCustomTemplatesObj = new $.oxoCustomTemplates();
	});
