...
(function( $ ) {
    ...
    window['oxo_builder_tinymce_count'] = 1;
        ...
        Editor.ElementPlaceholder = Backbone.View.extend(
            {
                ...
                render: function() {
                    ...
                    //update previews
                    oxoPreview.updatePreview( this, this.model, this.model.get( 'subElements' ) );
                ...
                openEditPanel: function() {
                    ...
                    if ( ElementName == "Slider" ) {
                        $.each(
                            $( "select[name*='oxo_slider_type']" ), function( key, value ) {
                ...
                updateElement: function() {
                    ...
                    //update previews
                    oxoPreview.updatePreview( this, this.model, originalSubElements );
                ...
                cloneElement: function() {
                    ...
                    if ( parent != null ) {
                        ...
                        if ( parentElement.get( 'css_class' ).indexOf( 'oxo_full_width' ) > -1 ) {
                            //update ChidlrendIDs
