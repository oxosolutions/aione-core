 ...
 */
	class TF_SocialLinks extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element name
			$this->config['name']	 		= __('Social Links', 'oxo-core');
			// element icon
			$this->config['icon_url']  		= "icons/sc-text_block.png";
			// css class related to this element
			$this->config['css_class'] 		= "oxo_element_box";
			// element icon class
			$this->config['icon_class']		= 'oxo-icon builder-options-icon oxoa-link';
		...
		public function create_visual_editor( $params ) {
			...
			$innerHtml .= '<div class="bilder_icon_container"><span class="oxo_iconbox_icon"><i class="oxoa-link"></i><sub class="sub">'.__('Social Links', 'oxo-core').'</sub></span></div>';
			$innerHtml .= '</div>';
		...
		array("name"	  => __('Instagram Link', 'oxo-core'),
				...
				array("name" 			=> __('Pinterest Link', 'oxo-core'),
				...
				array("name" 			=> __('Show Custom Social Icon', 'oxo-core'),
