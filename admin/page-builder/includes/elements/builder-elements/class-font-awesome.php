 ...
 */
	class TF_FontAwesome extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element name
			$this->config['name']	 	= __('Font Awesome', 'oxo-core');
			// element icon
			$this->config['icon_url']  	= "icons/sc-icon_box.png";
			// css class related to this element
			$this->config['css_class'] 	= "oxo_element_box";
			// element icon class
			$this->config['icon_class']	= 'oxo-icon builder-options-icon oxoa-flag';
		...
		public function create_visual_editor( $params ) {
			...
			$innerHtml  = '<div class="oxo_iconbox textblock_element textblock_element_style" id="oxo_font_awesome">';
			$innerHtml .= '<div class="bilder_icon_container"><span class="oxo_iconbox_icon"><h3 style="selector:hattrib"><i class="oxoa-flag" style="selector:iattrib"></i></h3></span></div>';
			$innerHtml .= '</div>';
