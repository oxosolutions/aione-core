 ...
 */
	class TF_ProgressBar extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element name
			$this->config['name']	 		= __('Progress Bar', 'oxo-core');
			// element icon
			$this->config['icon_url']  		= "icons/sc-text_block.png";
			// css class related to this element
			$this->config['css_class'] 		= "oxo_element_box";
			// element icon class
			$this->config['icon_class']		= 'oxo-icon builder-options-icon oxoa-tasks';
		...
		public function create_visual_editor( $params ) {
			...
			$innerHtml  = '<div class="oxo_iconbox textblock_element textblock_element_style" id="oxo_progress_bar">';
			$innerHtml .= '<div class="bilder_icon_container"><span class="oxo_iconbox_icon"><i class="oxoa-tasks"></i><sub class="sub">'.__('Progress Bar', 'oxo-core').'</sub><p class="progress_bar_text">HTML Skills</p></span></div>';
			$innerHtml .= '</div>';
		...
		function popup_elements() {
			...
			$filled_area 				= OxoHelper::oxo_create_dropdown_data( 1, 100 );
			...
			$this->config['subElements'] = array(
				...
				array("name" 			=> __('Progress Bar Unit', 'oxo-core'),
				...
				array("name" 			=> __('Filled Border Color', 'oxo-core'),
					  "desc" 			=> __('Controls the border color of the filled in area. Leave blank for theme option selection.', 'oxo-core'),
					  "id" 				=> "oxo_filledbordercolor",
					  "type" 			=> ElementTypeEnum::COLOR,
					  "value" 			=> ""
					  ),

				array("name" 			=> __('Filled Border Size', 'oxo-core'),
					  "desc"			=> __('In pixels (px), ex: 1px. Leave blank for theme option selection.', 'oxo-core'),
					  "id" 				=> "oxo_filledbordersize",
					  "type" 			=> ElementTypeEnum::INPUT,
					  "value" 			=> ""
					  ),
				...
				array("name" 			=> __('Unfilled Color', 'oxo-core'),
					  ...
					  "id" 				=> "oxo_unfilledcolor",
					  "type" 			=> ElementTypeEnum::COLOR,
					  "value" 			=> ""
					  ),
					  
				array("name" 			=> __('Striped Filling', 'oxo-core'),
				...
				array("name" 			=> __('Animated Stripes', 'oxo-core'),
					  "desc" 			=> __('Choose to get the the stripes animated.', 'oxo-core'),
					  "id" 				=> "oxo_animatedstripes",
					  "type" 			=> ElementTypeEnum::SELECT,
					  "value" 			=> "no",
					  "allowedValues" 	=> $reverse_choices 
					  ),
				...
				array("name" 			=> __('Progess Bar Text', 'oxo-core'),
