 ...
 */
	class TF_RevolutionSlider extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element name
			$this->config['name']	 		= __('Revolution Slider', 'oxo-core');
			// element icon
			$this->config['icon_url']  		= "icons/sc-text_block.png";
			// css class related to this element
			$this->config['css_class'] 		= "oxo_element_box";
			// element icon class
			$this->config['icon_class']		= 'oxo-icon builder-options-icon oxoa-air';
		...
		public function create_visual_editor( $params ) {
			...
			$innerHtml .= '<div class="bilder_icon_container"><span class="oxo_iconbox_icon"><i class="oxoa-air"></i><sub class="sub">'.__('Revolution Slider', 'oxo-core').'</sub><p>[rev_slider <span class="rev_slider_name">Aione</span>]</p></span></div>';
			$innerHtml .= '</div>';
		...
		function popup_elements() {
			$slider_options 	= OxoHelper::get_revslider_slides();
			
			$this->config['subElements'] = array(
				array("name" 			=> __('Select Slider', 'oxo-core'),
					  "desc" 			=> __('Select a slider.', 'oxo-core'),
					  "id" 				=> "oxo_revslider",
