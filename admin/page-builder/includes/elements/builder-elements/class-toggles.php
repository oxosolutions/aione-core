 ...
 */
	class TF_Toggles extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element name
			$this->config['name']	 		= __('Toggles', 'oxo-core');
			// element icon
			$this->config['icon_url']  		= "icons/sc-text_block.png";
			// css class related to this element
			$this->config['css_class'] 		= "oxo_element_box";
			// element icon class
			$this->config['icon_class']		= 'oxo-icon builder-options-icon oxoa-expand-alt';
		...
		public function create_visual_editor( $params ) {
			...
			$innerHtml  = '<div class="oxo_iconbox textblock_element textblock_element_style" id="oxo_toggles">';
			$innerHtml .= '<div class="bilder_icon_container"><span class="oxo_iconbox_icon"><i class="oxoa-expand-alt"></i><sub class="sub">'.__('Toggles', 'oxo-core').'</sub><ul class="toggles_content"><li>Toggle title here</li><li>Toggle title here</li><li>Toggle title here</li></ul></span></div>';
			$innerHtml .= '</div>';
	  ...
	  $am_array[] = array ( 
						  ...
						  array( "name"	 => __('Open by Default', 'oxo-core'),
										"desc"		=> __('Choose to have the toggle open when page loads', 'oxo-core'),
										"id"		=> "oxo_open[0]",
										"type"		=> ElementTypeEnum::SELECT,
										"value"	   => array('no') ,
									  "allowedValues"   => array('no'	 => __('No', 'oxo-core'),
																'yes'	 => __('Yes', 'oxo-core'))
							),
						  array( "name"	 => __('Toggle Content', 'oxo-core'),
			...
			$this->config['subElements'] = array(
				...
				array("type" 			=> ElementTypeEnum::ADDMORE,
					  "buttonText"		=> __('Add New Toggle', 'oxo-core'),
					  "id"				=> "am_oxo_toggle",
					  "elements" 		=> $am_array
					  ),
				);
