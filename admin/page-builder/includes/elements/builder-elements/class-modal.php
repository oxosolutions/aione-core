 ...
 */
	class TF_Modal extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element name
			$this->config['name']	 		= __('Modal', 'oxo-core');
			// element icon
			$this->config['icon_url']  		= "icons/sc-modal.png";
			// css class related to this element
			$this->config['css_class'] 		= "oxo_element_box";
			// element icon class
			$this->config['icon_class']		= 'oxo-icon builder-options-icon oxoa-external-link';
		...
		public function create_visual_editor( $params ) {
			...
			$innerHtml  = '<div class="oxo_iconbox textblock_element textblock_element_style" id="oxo_modal">';
			$innerHtml .= '<div class="bilder_icon_container"><span class="oxo_iconbox_icon"><i class="oxoa-external-link"></i><sub class="sub">'.__('Modal', 'oxo-core').'</sub><p>modal name = <span class="modal_name">myModal</span></p></span></div>';
			$innerHtml .= '</div>';
		...
		function popup_elements() {
			...
			$this->config['subElements'] = array(
			   ...
			   array("name" 			=> __('Name Of Modal', 'oxo-core'),
				...
				array("name" 			=> __('Modal Heading', 'oxo-core'),
				...
				array("name" 			=> __('Size Of Modal', 'oxo-core'),
					  "desc" 			=> __('Select the modal window size.', 'oxo-core'),
					  "id" 				=> "oxo_size",
					  "type" 			=> ElementTypeEnum::SELECT,
					  "value" 			=> "",
					  "allowedValues" 	=> array('small' 			=> __('Small', 'oxo-core'),
				...
				array("name" 			=> __('Show Footer', 'oxo-core'),
				...
				array("name" 			=> __('Contents of Modal', 'oxo-core'),
