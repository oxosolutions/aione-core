 ...
 */
	class TF_MenuAnchor extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element name
			$this->config['name']	 		= __('Menu Anchor', 'oxo-core');
			// element icon
			$this->config['icon_url']  		= "icons/sc-menu_anchor.png";
			// css class related to this element
			$this->config['css_class'] 		= "oxo_element_box";
			// element icon class
			$this->config['icon_class']		= 'oxo-icon builder-options-icon oxoa-anchor';
		...
		public function create_visual_editor( $params ) {
			...
			$innerHtml .= '<div class="bilder_icon_container"><span class="oxo_iconbox_icon"><i class="oxoa-anchor"></i><sub class="sub">'.__('Menu Anchor', 'oxo-core').'</sub><p>menu anchor name = <span class="anchor_name">myAnchor</span></p></span></div>';
			$innerHtml .= '</div>';
		...
		function popup_elements() {
			...
			$this->config['subElements'] = array(
			   ...
			   array("name" 			=> __('Name Of Menu Anchor', 'oxo-core'),
