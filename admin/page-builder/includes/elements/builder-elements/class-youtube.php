<?php
	...
	class TF_Youtube extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element name
			$this->config['name'] = __( 'Youtube', 'oxo-core' );
			// element icon
			$this->config['icon_url'] = "icons/sc-text_block.png";
			// css class related to this element
			$this->config['css_class'] = "oxo_element_box";
			// element icon class
			$this->config['icon_class'] = 'oxo-icon builder-options-icon oxoa-youtube';
		...
		public function create_visual_editor( $params ) {
			...
			$innerHtml .= '<div class="bilder_icon_container"><span class="oxo_iconbox_icon"><i class="oxoa-youtube"></i><sub class="sub">' . __( 'Youtube', 'oxo-core' ) . '</sub><p class="youtube_url">http://www.youtube.com/LOfeCR7KqUs</p></span></div>';
			$innerHtml .= '</div>';
		...
		function popup_elements() {
			...
			$this->config['subElements'] = array(
				...
				array(
					"name"          => __( 'Autoplay Video', 'oxo-core' ),
				...
				array(
					"name"  => __( 'AdditionalAPI Parameter', 'oxo-core' ),
