 ...
 */
	class TF_FlipBoxes extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element name
			$this->config['name']	 		= __('Flip Boxes', 'oxo-core');
			// element icon
			$this->config['icon_url']  		= "icons/sc-text_block.png";
			// css class related to this element
			$this->config['css_class'] 		= "oxo_element_box";
			// element icon class
			$this->config['icon_class']		= 'oxo-icon builder-options-icon oxoa-loop-alt2';
		...
		public function create_visual_editor( $params ) {
			...
			$innerHtml  = '<div class="oxo_iconbox textblock_element textblock_element_style" id="oxo_flip_boxs">';
			$innerHtml .= '<div class="bilder_icon_container"><span class="oxo_iconbox_icon"><i class="oxoa-loop-alt2"></i><sub class="sub">'.__('Flip Boxes', 'oxo-core').'</sub><p>columns = <font class="flip_boxes_columns">5</font></p></span></div>';
			$innerHtml .= '</div>';
		...
		function popup_elements( $am_elements ) {
			...
			$am_array[] = array ( 
													...
													array("name" 			=> __('Background Color Frontside', 'oxo-core'),
					  								...
					  								"id" 					=> "oxo_backgroundcolorfront[0]",
					  								"type" 					=> ElementTypeEnum::COLOR,
					  								"value" 				=> array ()
					  								),
													array("name" 			=> __('Heading Color Frontside', 'oxo-core'),
					  								"desc" 					=> __('Controls the heading color of the frontside. Leave blank for theme option selection.', 'oxo-core'),
					  								"id" 					=> "oxo_titlecolorfront[0]",
					  								"type" 					=> ElementTypeEnum::COLOR,
					  								"value" 				=> array ()
					  								),
													array("name" 			=> __('Text Color Frontside', 'oxo-core'),
					  								"desc" 					=> __('Controls the text color of the frontside. Leave blank for theme option selection.', 'oxo-core'),
					  								"id" 					=> "oxo_textcolorfront[0]",
					  								"type" 					=> ElementTypeEnum::COLOR,
					  								"value" 				=> array ()
					  								),
													array("name" 			=> __('Background Color Backside', 'oxo-core'),
													...
													array("name" 			=> __('Icon Circle', 'oxo-core'),
													...
													array("name" 			=> __('Icon Circle Background Color', 'oxo-core'),
													...
													array("name" 			=> __('Icon Circle Border Color', 'oxo-core'),
			...
			$this->config['subElements'] = array(
				...
				array("type" 			=> ElementTypeEnum::ADDMORE,
					  "buttonText"		=> __('Add New Flip Box', 'oxo-core'),
					  "id"				=> "am_oxo_content",
					  "elements" 		=> $am_array
					  ),
				);
