 ...
 */
	class TF_OxoText extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element icon class
			$this->config['icon_class']		= 'oxo-icon builder-options-icon oxoa-font';
		...
		public function create_visual_editor( $params ) {
			...
			$innerHtml .= '<div class="bilder_icon_container"><span class="oxo_iconbox_icon"></span></div>';
			$innerHtml .= '</div>';
		...
		function popup_elements() {
			...
			$this->config['subElements'] = array(
				...
				array("name" 			=> __('Content', 'oxo-core'),
					  "desc" 			=> __('Enter some content for this textblock', 'oxo-core'),
					  "id" 				=> "oxo_content_wp",
					  "type" 			=> ElementTypeEnum::HTML_EDITOR,
					  "value" 			=> __('Click edit button to change this text.', 'oxo-core')
					  ),
				);
		}
	}