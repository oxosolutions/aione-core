...
class BuilderElements {
	...
	public function __construct() 
	{
		...
		$this->value['name'] 	= __('Elements', 'oxo-core');
		$this->value['icon'] 	= "icon_pack/tab_icon_4.png";
		$this->value['class']	= "oxo-tab oxoa-TFicon";
	...
	private function load_elements() 
	{
		...
		array_push($this->elements, $oxoslider->element_to_array());
		...
		if ( is_plugin_active( $LayerSlider ) ) { 
		...
		$form		= new TF_Form();
		array_push($this->elements, $form->element_to_array());
		
		$aionegallery 		= new TF_AioneGallery();
		array_push($this->elements, $aionegallery ->element_to_array());
