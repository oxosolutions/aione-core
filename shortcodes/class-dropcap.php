...
class OxoSC_Dropcap {
	...
	public function __construct() {
		...
		add_filter( 'oxo_attr_dropcap-shortcode', array( $this, 'attr' ) );
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( '<span %s>%s</span>', OxoCore_Plugin::attributes( 'dropcap-shortcode' ), do_shortcode( $content ) );
	...
	function attr() {
		...
		$attr['class'] = 'oxo-dropcap dropcap';
		$attr['style'] = '';
