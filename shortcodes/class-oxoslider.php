...
class OxoSC_OxoSlider {
	...
	public function __construct() {
		...
		add_shortcode( 'oxoslider', array( $this, 'render_parent' ) );

		add_filter( 'oxo_attr_oxo-slider-wrapper', array( $this, 'wrapper_attr' ) );
		add_filter( 'oxo_attr_oxo-slider-container', array( $this, 'container_attr' ) );
	...
	function render_parent( $args, $content = '') {
		...
		if ( $query->have_posts() ) {
		?>
			<div <?php echo OxoCore_Plugin::attributes( 'oxo-slider-wrapper' ); ?>>
				<style type="text/css" scoped="scoped">
				.oxo-slider-<?php echo $term_details->term_id; ?> .flex-direction-nav a {
					<?php
				...
				<div class="oxo-slider-loading"><?php _e( 'Loading...', 'oxo-core' ); ?></div>
				<div <?php echo OxoCore_Plugin::attributes( 'oxo-slider-container' ); ?>>
					<ul class="slides">
						<?php
	...
	function wrapper_attr() {
		...
		$attr['class'] = 'oxo-slider-container';

		$term_details = get_term_by( 'slug', self::$parent_args['name'], 'slide-page' );

		$attr['class'] .= ' oxo-slider-' . $term_details->term_id;
		...
		$attr['id'] = 'oxo-slider-sc-' . self::$parent_args['name'];
