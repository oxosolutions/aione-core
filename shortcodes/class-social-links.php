...
class OxoSC_SocialLinks {
	...
	public function __construct() {
		...
		add_filter( 'oxo_attr_social-links-shortcode', array( $this, 'attr' ) );
		add_filter( 'oxo_attr_social-links-shortcode-social-networks', array( $this, 'social_networks_attr' ) );	
		add_filter( 'oxo_attr_social-links-shortcode-icon', array( $this, 'icon_attr' ) );	
	...
	function render( $args, $content = '') {
		...
		//$social_networks = OxoCore_Plugin::order_array_like_array( $social_networks, $icon_order );
		...
		foreach( $social_networks as $network => $link ) {
			...
			$icons .= sprintf( '<a %s>%s</a>', OxoCore_Plugin::attributes( 'social-links-shortcode-icon', $icon_options ), $custom );
			$i++;
		}
			
		$html = sprintf( '<div %s><div %s><div %s>%s</div></div></div>', OxoCore_Plugin::attributes( 'social-links-shortcode' ), OxoCore_Plugin::attributes( 'social-links-shortcode-social-networks' ), OxoCore_Plugin::attributes( 'oxo-social-networks-wrapper' ), $icons );
