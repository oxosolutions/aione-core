...
class OxoSC_ContentBoxes {
	...
	public function __construct() {
		...
		add_filter( 'oxo_attr_content-box-shortcode', array( $this, 'child_attr' ) );
		add_filter( 'oxo_attr_content-box-shortcode-content-wrapper', array( $this, 'content_wrapper_attr' ) );
		add_filter( 'oxo_attr_content-box-shortcode-heading-wrapper', array( $this, 'heading_wrapper_attr' ) );
		add_filter( 'oxo_attr_content-box-shortcode-content-container', array( $this, 'content_container_attr' ) );
		
		add_filter( 'oxo_attr_content-box-shortcode-link', array( $this, 'link_attr' ) );
		add_filter( 'oxo_attr_content-box-shortcode-icon-parent', array( $this, 'icon_parent_attr' ) );
		add_filter( 'oxo_attr_content-box-shortcode-icon-wrapper', array( $this, 'icon_wrapper_attr' ) );
		add_filter( 'oxo_attr_content-box-shortcode-icon', array( $this, 'icon_attr' ) );
		add_filter( 'oxo_attr_content-box-shortcode-timeline', array( $this, 'timeline_attr' ) );
		add_filter( 'oxo_attr_content-box-heading', array( $this, 'content_box_heading_attr' ) );
		add_shortcode( 'content_box', array( $this, 'render_child' ) );

		add_filter( 'oxo_attr_content-boxes-shortcode', array( $this, 'parent_attr' ) );
	...
	function render_parent( $args, $content = '') {
		...
		$defaults =	OxoCore_Plugin::set_shortcode_defaults(
			array(
				...
				'animation_speed'		=> '0.1',
				'animation_offset'		=> Aione()->settings->get( 'animation_offset' ),
				'settings_lvl'			=> 'child',
		...
		if( $title_color ) {
			$styles .= ".oxo-content-boxes-{$this->content_box_counter} .heading h2{color:{$title_color};}";
		}

		$styles .= "
			.oxo-content-boxes-{$this->content_box_counter} .oxo-content-box-hover .link-area-link-icon-hover .heading h2,
			.oxo-content-boxes-{$this->content_box_counter} .oxo-content-box-hover .link-area-link-icon-hover .heading .heading-link h2,
			.oxo-content-boxes-{$this->content_box_counter} .oxo-content-box-hover .link-area-box-hover .heading h2,
			.oxo-content-boxes-{$this->content_box_counter} .oxo-content-box-hover .link-area-box-hover .heading .heading-link h2,
			.oxo-content-boxes-{$this->content_box_counter} .oxo-content-box-hover .link-area-link-icon-hover.link-area-box .oxo-read-more,
			.oxo-content-boxes-{$this->content_box_counter} .oxo-content-box-hover .link-area-link-icon-hover.link-area-box .oxo-read-more::after,
			.oxo-content-boxes-{$this->content_box_counter} .oxo-content-box-hover .link-area-link-icon-hover.link-area-box .oxo-read-more::before,
			.oxo-content-boxes-{$this->content_box_counter} .oxo-content-box-hover .oxo-read-more:hover:after,
			.oxo-content-boxes-{$this->content_box_counter} .oxo-content-box-hover .oxo-read-more:hover:before,
			.oxo-content-boxes-{$this->content_box_counter} .oxo-content-box-hover .oxo-read-more:hover,
			.oxo-content-boxes-{$this->content_box_counter} .oxo-content-box-hover .link-area-box-hover.link-area-box .oxo-read-more,
			.oxo-content-boxes-{$this->content_box_counter} .oxo-content-box-hover .link-area-box-hover.link-area-box .oxo-read-more::after,
			.oxo-content-boxes-{$this->content_box_counter} .oxo-content-box-hover .link-area-box-hover.link-area-box .oxo-read-more::before,			
			.oxo-content-boxes-{$this->content_box_counter} .oxo-content-box-hover .link-area-link-icon-hover .icon .circle-no,
			.oxo-content-boxes-{$this->content_box_counter} .oxo-content-box-hover .link-area-box-hover .icon .circle-no {
		...
		$styles .= "
			.oxo-content-boxes-{$this->content_box_counter} .oxo-content-box-hover .heading-link:hover .icon i.circle-yes,
			.oxo-content-boxes-{$this->content_box_counter} .oxo-content-box-hover .link-area-box:hover .heading-link .icon i.circle-yes,
			.oxo-content-boxes-{$this->content_box_counter} .oxo-content-box-hover .link-area-link-icon-hover .heading .icon i.circle-yes,
			.oxo-content-boxes-{$this->content_box_counter} .oxo-content-box-hover .link-area-box-hover .heading .icon i.circle-yes {
		...
		if ( $icon_hover_type == 'pulsate' && $hover_accent_color ) {
			...
			$styles .= "
				.oxo-content-boxes-{$this->content_box_counter} .oxo-content-box-hover .link-area-link-icon-hover.icon-hover-animation-pulsate .fontawesome-icon:after,
				.oxo-content-boxes-{$this->content_box_counter} .oxo-content-box-hover .link-area-box-hover.icon-hover-animation-pulsate .fontawesome-icon:after,
				.oxo-content-boxes-{$this->content_box_counter} .oxo-content-box-hover .link-area-link-icon-hover.icon-wrapper-hover-animation-pulsate .icon span:after,
				.oxo-content-boxes-{$this->content_box_counter} .oxo-content-box-hover .link-area-box-hover.icon-wrapper-hover-animation-pulsate .icon span:after {
		...
		$html = sprintf( '<div %s>%s%s<div class="oxo-clearfix"></div></div>', OxoCore_Plugin::attributes( 'content-boxes-shortcode' ), $styles, do_shortcode( $content ) );
	...
	function parent_attr() {
		...
		$attr['class'] = sprintf( 'oxo-content-boxes content-boxes columns oxo-columns-%s oxo-columns-total-%s oxo-content-boxes-%s content-boxes-%s row content-%s', $this->num_of_columns, $this->total_num_of_columns, $this->content_box_counter, self::$parent_args['layout'], self::$parent_args['icon_align'] );
		...
		if( self::$parent_args['animation_delay'] ) {
			...
			$attr['class'] .= ' oxo-delayed-animation';
		}
		
		if ( self::$parent_args['animation_offset'] ) {
			$animations = OxoCore_Plugin::animations( array(
		...
		$attr['style'] = sprintf( 'margin-top:%s;margin-bottom:%s;', Aione_Sanitize::get_value_with_unit( self::$parent_args['margin_top'] ), Aione_Sanitize::get_value_with_unit( self::$parent_args['margin_bottom'] ) );
	...
	function render_child( $args, $content = '') {
		...
		if( $image && 
			...
			$image_id = OxoCore_Plugin::get_attachment_id_from_url( $image );

			if( $image_id ) {
				$alt = get_post_meta( $image_id, '_wp_attachment_image_alt', true );
			}
		
			$icon_output = sprintf( '<div %s><img src="%s" width="%s" height="%s" alt="%s" /></div>', OxoCore_Plugin::attributes( 'content-box-shortcode-icon' ), $image, $image_width, $image_height, $alt );
		} elseif( $icon ) {
			if( $outercirclebordercolor && $outercirclebordersize ) {
				$icon_output = sprintf( '<div %s><span %s><i %s></i></span></div>', OxoCore_Plugin::attributes( 'content-box-shortcode-icon-parent' ), OxoCore_Plugin::attributes( 'content-box-shortcode-icon-wrapper' ), OxoCore_Plugin::attributes( 'content-box-shortcode-icon' ) );
			} else {
				$icon_output = sprintf( '<div %s><i %s></i></div>', OxoCore_Plugin::attributes( 'content-box-shortcode-icon-parent' ), OxoCore_Plugin::attributes( 'content-box-shortcode-icon' ) );
			}
		}

		if( $title ) {
			$title_output = sprintf( '<h2 %s>%s</h2>', OxoCore_Plugin::attributes( 'content-box-heading' ), $title );
		}
		...
		if( $link ) {
			$heading_content = sprintf( '<a %s %s>%s</a>', OxoCore_Plugin::attributes( 'heading-link' ), 
										OxoCore_Plugin::attributes( 'content-box-shortcode-link' ), $heading_content );
		}
		
		if ( $heading_content ) {
			$heading = sprintf( '<div %s>%s</div>', OxoCore_Plugin::attributes( 'content-box-shortcode-heading-wrapper' ), $heading_content );
		}
		...
		if( $link &&  
			...
			if( self::$parent_args['link_type'] == 'text' || self::$parent_args['link_type'] == 'button-bar' ) {
				$link_output = sprintf( '<div class="oxo-clearfix"></div><a %s %s>%s</a><div class="oxo-clearfix"></div>', OxoCore_Plugin::attributes( 'oxo-read-more' ), OxoCore_Plugin::attributes( 'content-box-shortcode-link', array( 'readmore' => true ) ), $linktext );
			} else if( self::$parent_args['link_type'] == 'button' ) {
				$link_output = sprintf( '<div class="oxo-clearfix"></div><a %s>%s</a><div class="oxo-clearfix"></div>', OxoCore_Plugin::attributes( 'content-box-shortcode-link' ), $linktext );
			}
		}

		$content_output = sprintf( '<div class="oxo-clearfix"></div><div %s>%s</div>', OxoCore_Plugin::attributes( 'content-box-shortcode-content-container'), do_shortcode( $content ) . $link_output );
		...
		if( $icon && self::$parent_args['icon_circle'] == 'yes' && self::$parent_args['layout'] == 'timeline-horizontal' && self::$parent_args['columns'] != '1' ) {
			$timeline = sprintf( '<div %s></div>', OxoCore_Plugin::attributes( 'content-box-shortcode-timeline' ) );
		}
		...
		$html = sprintf( '<div %s><div %s>%s%s</div></div>', OxoCore_Plugin::attributes( 'content-box-shortcode' ), 
						 OxoCore_Plugin::attributes( 'content-box-shortcode-content-wrapper' ), $output, $timeline );
	...
	function child_attr() {
		...
		$attr['style'] = '';
		$attr['class'] = sprintf( 'oxo-column content-box-column content-box-column-%s col-lg-%s col-md-%s col-sm-%s', $this->column_counter, $columns, $columns, $columns );
		
		if ( $this->num_of_columns == '5'  ) {
			$attr['class'] = sprintf( 'oxo-column content-box-column content-box-column-%s col-lg-2 col-md-2 col-sm-2', $this->column_counter );
		}		


		$attr['class'] .= ' oxo-content-box-hover';
	...
	function link_attr( $args ) {
		...
		if( self::$parent_args['link_type'] == 'button' ) {
			$attr['class'] .= sprintf( 'oxo-read-more-button oxo-button oxo-button-default oxo-button-%s oxo-button-%s oxo-button-%s', strtolower( $smof_data['button_size'] ), strtolower( $smof_data['button_shape'] ), strtolower( $smof_data['button_type'] ) );
		}
	...
	function icon_attr() {
		...
		if( self::$child_args['image'] ) {
			...
			$attr['class'] = sprintf( 'fa fontawesome-icon %s', OxoCore_Plugin::font_awesome_name_handler( self::$child_args['icon'] ) );
			...
			$attr['style'] .= sprintf( 'font-size:%spx;', OxoCore_Plugin::strip_unit( self::$parent_args['icon_size'] ) );
		}
	...
	function content_box_heading_attr() {
		...
		if( self::$parent_args['title_size'] ) {
			$font_size = OxoCore_Plugin::strip_unit( self::$parent_args['title_size'] );
