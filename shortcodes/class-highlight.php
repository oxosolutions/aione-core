...
class OxoSC_Highlight {
	...
	public function __construct() {
		...
		add_filter( 'oxo_attr_highlight-shortcode', array( $this, 'attr' ) );
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( '<span %s>%s</span>', OxoCore_Plugin::attributes( 'highlight-shortcode' ), do_shortcode($content) );
	...
	function attr() {
		...
		$attr['class'] = 'oxo-highlight';

		$brightness_level = OxoCore_Plugin::calc_color_brightness( self::$args['color'] );
