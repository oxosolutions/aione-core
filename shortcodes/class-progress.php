...
class OxoSC_Progressbar {
	...
	public function __construct() {
		...
		add_filter( 'oxo_attr_progressbar-shortcode', array( $this, 'attr' ) );
		add_filter( 'oxo_attr_progressbar-shortcode-content', array( $this, 'content_attr' ) );
		add_filter( 'oxo_attr_progressbar-shortcode-span', array( $this, 'span_attr' ) );
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( '<div %s><div %s></div><span %s>%s %s%s</span></div>', OxoCore_Plugin::attributes( 'progressbar-shortcode' ), OxoCore_Plugin::attributes( 'progressbar-shortcode-content' ),
						  OxoCore_Plugin::attributes( 'progressbar-shortcode-span' ), $content, $percentage, $unit );
	...
	function attr() {
		...
		$attr['class'] = 'oxo-progressbar progress-bar';
