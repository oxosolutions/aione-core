...
class OxoSC_CountersCircle {
	...
	public function __construct() {
		...
		add_filter( 'oxo_attr_counters-circle-shortcode', array( $this, 'parent_attr' ) );
		add_shortcode( 'counters_circle', array( $this, 'render_parent' ) );

		add_filter( 'oxo_attr_counter-circle-shortcode', array( $this, 'child_attr' ) );
		add_filter( 'oxo_attr_counter-circle-wrapper-shortcode', array( $this, 'child_wrapper_attr' ) );
	...
	function render_parent( $args, $content = '' ) {
		...
		$html = sprintf( '<div %s>%s</div>', OxoCore_Plugin::attributes( 'counters-circle-shortcode' ), do_shortcode( $content ) );
	...
	function parent_attr() {
		...
		$attr['class'] = 'oxo-counters-circle counters-circle';
	...
	function render_child( $args, $content = '' ) {
		...
		$output = sprintf( '<div %s>%s</div>', OxoCore_Plugin::attributes( 'counter-circle-shortcode' ), do_shortcode( $content ) );

		$html = sprintf( '<div %s>%s</div>', OxoCore_Plugin::attributes( 'counter-circle-wrapper-shortcode' ), $output );
	...
	function child_attr() {
		...
		$attr['class'] = 'oxo-counter-circle counter-circle counter-circle-content';
